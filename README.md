...
<div align="center">
  ...
  <h3 align="center">UdaConnect - Message Passing</h3>

  <p align="center">
    Microservice architecture using message passing 
    <br />
    <br />
    -----------------------------------------------
    <br />
...
<details open>
  ...
  <ol>
    ...
    <li><a href="#verifying-it-works">Verifying it Works</a></li>
...
6. `kubectl apply -f deployment/udaconnect-connection-service.yaml` - Set up the service and deployment for the connection API
7. `kubectl apply -f deployment/udaconnect-person-service.yaml` - Set up the service and deployment for the person API
8. `kubectl apply -f deployment/udaconnect-location-generator-service.yaml` - Set up the location data producer service
9. `kubectl apply -f deployment/udaconnect-location-ingestion-service.yaml` - Set up the location data consumer service
...
Use the following commands to get the pods and services:

`kubectl get pods` and `kubectl get services`

These pages should also load on your web browser:

-   `http://localhost:30005/` - OpenAPI Documentation for connections
-   `http://localhost:30005/api/` - Base path for connections API
-   `http://localhost:30006/` - OpenAPI Documentation for persons
-   `http://localhost:30005/api/` - Base path for persons API
-   `http://localhost:30000/` - Frontend ReactJS Application
-   `http://localhost:30001/api/` - OpenAPI Documentation for old API
